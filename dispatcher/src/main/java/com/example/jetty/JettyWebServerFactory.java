...
public class JettyWebServerFactory implements ConfigurableServletWebServerFactory {
	...
	public JettyWebServerFactory(ServerProperties server) {
		this.server = server;
	}
	...
	public WebServer getWebServer(ServletContextInitializer... initializers) {
		return new JettyWebServer(this.server.getPort() != null ? this.server.getPort() : 8080, initializers);
	}
