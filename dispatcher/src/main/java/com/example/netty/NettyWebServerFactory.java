 ...
 *
 */
public class NettyWebServerFactory implements ConfigurableServletWebServerFactory {
	...
	public NettyWebServerFactory(ServerProperties server) {
		this.server = server;
	}
	...
	public WebServer getWebServer(ServletContextInitializer... initializers) {
		return new NettyWebServer(server.getPort() != null ? server.getPort() : 8080, initializers);
	}
