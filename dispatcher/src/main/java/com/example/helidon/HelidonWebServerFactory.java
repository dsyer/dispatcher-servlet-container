...
public class HelidonWebServerFactory implements ConfigurableServletWebServerFactory {
	...
	public HelidonWebServerFactory(ServerProperties server) {
		this.server = server;
	}
	...
	public WebServer getWebServer(ServletContextInitializer... initializers) {
		return new HelidonWebServer(server.getPort() != null ? server.getPort() : 8080, initializers);
	}
