 ...
 * @since 3.2
 */
public class DispatcherAsyncContext implements AsyncContext {
	...
	public DispatcherAsyncContext(ServletRequest request, @Nullable ServletResponse response) {
	...
	public boolean hasOriginalRequestAndResponse() {
		return (this.request instanceof DispatcherHttpServletRequest && this.response instanceof DispatcherHttpServletResponse);
	}
	...
	public void complete() {
		DispatcherHttpServletRequest mockRequest = WebUtils.getNativeRequest(this.request, DispatcherHttpServletRequest.class);
		if (mockRequest != null) {
