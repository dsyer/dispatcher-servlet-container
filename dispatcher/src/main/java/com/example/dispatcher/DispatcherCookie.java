 ...
 * @since 5.1
 */
public class DispatcherCookie extends Cookie {
	...
	/**
	 * Construct a new {@link DispatcherCookie} with the supplied name and value.
	 * @param name the name
	 * @param value the value
	 * @see Cookie#Cookie(String, String)
	 */
	public DispatcherCookie(String name, String value) {
		super(name, value);
	}
	 ...
	 * requests if the supplied value is {@code "Strict"} or cross-site requests if the
	 ...
	 */
	public static DispatcherCookie parse(String setCookieHeader) {
		...
		DispatcherCookie cookie = new DispatcherCookie(name, value);
