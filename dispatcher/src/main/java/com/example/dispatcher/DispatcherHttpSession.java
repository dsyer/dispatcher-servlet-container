...
public class DispatcherHttpSession implements HttpSession {
	 ...
	 */
	public DispatcherHttpSession(@Nullable ServletContext servletContext) {
	 ...
	 */
	public DispatcherHttpSession(@Nullable ServletContext servletContext, @Nullable String id) {
	...
	/**
	 * Serialize the attributes of this session into an object that can be turned into a
	 * byte array with standard Java serialization.
